...
function sim(
	...
	for iter = 1:num_steps
		...
		move!(robot_path, best_direction, Δr=Δr)
		if isnothing(model_params)
...
model_simulation_data, model_simulation_chains = sim(30, method="thompson", save_chains=true, num_mcmc_samples=600, num_mcmc_chains=2, model_params=example_params, Δr=example_params["Δx_y"])
